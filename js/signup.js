function signupchk() {
    ...
    if (chkUserName) {
        ...
        form.userName.style.borderColor = '#FD9F28';
    } else {
        form.userName.style.border = '2px solid';
    ...
    if (chkUserID) {
        ...
        form.userID.style.borderColor = '#FD9F28';
    } else {
        form.userID.style.border = '2px solid';
    ...
    if (chkEmail) {
        ...
        form.userEmail.style.borderColor = '#FD9F28';
    } else {
        form.userEmail.style.border = '2px solid';
    ...
    if (chkPw) {
        ...
        form.userPassword.style.borderColor = '#FD9F28';
    } else {
        form.userPassword.style.border = '2px solid';
